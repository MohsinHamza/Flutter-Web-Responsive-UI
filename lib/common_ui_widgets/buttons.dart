...
class Buttons {
  ...
  static CupertinoButton customButtonWithLeadingIcon(
          {double buttonWidth = 128.87,
          double? buttonHeight,
          double borderRoundness = 5.0,
      ...
      CupertinoButton(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              Visibility(
                visible: buttonImageName != null,
                child: Padding(
                  padding: const EdgeInsets.only(left: 12.0,right: 8),
                  child: Image(
                    image: AssetImage('assets/icons/$buttonImageName.png'),
                    width: 27,
                    height: 22,
                    color: textColor,
                  ),
